    ...
    <div className="p-4 lg:p-6">
       ...
       <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-6 mb-6">
         <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
           <div>
             <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Dashboard en Tiempo Real</h1>
             <p className="text-gray-600">Monitoreo activo de la carnicería</p>
           </div>
           ...
           <div className="space-y-3">
             {realTimeData.alertas.map((alerta, index) => (
               <div key={index} className={`p-3 rounded-2xl border-l-4 ${
                 ...
                 <div className="flex items-center justify-between">
                   <div>
                     <p className="font-medium text-gray-900">{alerta.message}</p>
         ...
         <div className="card">
           ...
           <div className="space-y-3">
             {recentSales.map((sale) => (
               <div key={sale.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors duration-200">
                 <div className="flex items-center space-x-3">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-gray-500">{sale.hora} • {sale.productos} items</p>
                   </div>
                 </div>
                 <p className="font-bold text-gray-900">${sale.monto.toLocaleString()}</p>
               </div>
             ))}
           </div>
         </div>
